...
model = ConfigNet(stereo_model=stereo_model, stn_mode='projective', right_head=False, ext_disp2depth=False).to(device)
...
show_images_in_train = True
show_images_after_test = True
